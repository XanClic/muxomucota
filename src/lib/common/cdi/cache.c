...
//#undef __LOST__
    ...
    #include <cdi.h>
    #include <cdi/misc.h>
    #include <tyndur-collections.h>
#else
    #include "tree.h"
#endif
#include <cdi/cache.h>

#define INVBLKNUM (~0UL)
 ...
 */
void cdi_cache_block_release(struct cdi_cache* cache __attribute__((unused)),
 ...
 * @param block Block-Handle
 */
void cdi_cache_block_dirty(struct cdi_cache* cache __attribute__((unused)),
    struct cdi_cache_block* block)
{
    struct block* b = (struct block*) block;
    b->dirty = 1;
